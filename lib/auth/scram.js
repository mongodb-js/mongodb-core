...
class ScramSHA extends AuthProvider {
   ...
   * @ignore
   */
  _executeScram(writeCommand, connection, credentials, nonce, callback) {
    ...
    writeCommand(connection, `${db}.$cmd`, saslStartCmd, (err, r) => {
      ...
      // Write the commmand on the connection
      writeCommand(connection, `${db}.$cmd`, saslContinueCmd, (err, r) => {
        ...
        // Write the commmand on the connection
        writeCommand(connection, `${db}.$cmd`, retrySaslContinueCmd, callback);
      });
    });
  }
