...
ScramSHA1.prototype.auth = function(server, connections, db, username, password, callback) {
  ...
  // Execute MongoCR
  var executeScram = function(connection, nonce) {
    // nonce = 'MsQUY9iw0T9fx2MUEz6LZPwGuhVvWAhc'
    // Clean up the user
  ...
  var _execute = function(_connection) {
    process.nextTick(function() {
      crypto.randomBytes(24, function (eIgnore, buff) {
        var nonce = buff.toString('base64');
        executeScram(_connection, nonce);
      });
    });
  };
