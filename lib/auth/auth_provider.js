...
class AuthProvider {
  ...
  /**
   * Abstraction of building a command
   * @private
   * @param {sting} namespace Namespace of command
   * @param {object} cmd command object
   * @return {Query} currently returns a Query object, but really can be any command
   */
