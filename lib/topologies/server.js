...
Server.prototype.command = function(ns, cmd, options, callback) {
  ...
  // if collation not supported, will call callback with new MongoError
  if (collationNotSupported(this, cmd, callback)) return;
...
Server.prototype.update = function(ns, ops, options, callback) {
  ...
  // if collation not supported, will call callback with new MongoError
  if (collationNotSupported(this, options, callback)) return;
