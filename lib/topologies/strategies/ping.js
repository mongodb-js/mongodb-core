 ...
 * @class
 * @param {number} [options.pingInterval=10000] Ping interval to check the response time to the different servers
 * @param {number} [options.acceptableLatency=15] Acceptable latency for selecting a server for reading (in milliseconds)
