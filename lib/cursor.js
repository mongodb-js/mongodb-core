...
Cursor.prototype._getmore = function(callback) {
  ...
  this.server.protocol.getMore(this.bson, this.ns, this.cursorState, batchSize, raw, this.connection, this.callbacks, this.options, callback);
}
...
Cursor.prototype._killcursor = function(callback) {
  ...
  // Execute command
  this.server.protocol.killCursor(this.bson, this.ns, this.cursorState.cursorId, this.connection, this.callbacks, callback);
}
...
var nextFunction = function(self, callback) {
  ...
  if(!self.cursorState.init) {
    ...
    try {
      ...
      self.query = self.server.protocol.command(self.bson, self.ns, self.cmd, self.cursorState, self.topology, self.options);
    } catch(err) {
      return callback(err);
    }
  }
