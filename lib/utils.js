...
const noEJSONError = function() {
  throw new Error(
    'APM Logging via URI string requires the `mongodb-extjson` package for parsing event objects, but it was not found. Install the package or disable APM logging and try again.'
  );
};
