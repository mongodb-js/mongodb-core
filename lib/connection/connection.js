...
var emitMessageHandler = function (message) {
  ...
  if (msgHeader.opCode === OP_COMPRESSED) {
    ...
    self.messageHandler(new Response(self.bson, msgHeader, msgBody, self.responseOptions), self);
  }
}
