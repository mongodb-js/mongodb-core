...
const getDefaultAuthProviders = require('../auth/defaultAuthProviders').getDefaultAuthProviders;
...
var Pool = function(topology, options) {
  ...
  this.authProviders = options.authProviders || getDefaultAuthProviders(options.bson);
